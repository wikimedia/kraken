...
public class ZeroFilterFunc extends FilterFunc {
    ...
    public ZeroFilterFunc() {
        ...
        config.put("250-99/Beeline/Beeline Russia", new ZeroConfig("Russia", "Beeline", createStartDate(2014, 1, 1), true, true, new String[] {"ru", "en", ""}, null));
        config.put("293-41/IPKO/IPKO Kosovo", new ZeroConfig("Kosovo", "IPKO", createStartDate(2014, 1, 1), true, true, new String[] {}, null));
        config.put("297-01/Telenor/Telenor Montenegro", new ZeroConfig("Montenegro", "Telenor", createStartDate(2014, 1, 1), true, true, new String[] {}, null));
        config.put("401-01/Beeline/Beeline Kazakhstan", new ZeroConfig("Kazakhstan", "Beeline", createStartDate(2014, 1, 1), true, true, new String[] {"ru", "kk", "en", ""}, null));
        config.put("404-01/Aircel/Aircel India", new ZeroConfig("India", "Aircel", createStartDate(2014, 1, 1), true, true, new String[] {}, null));
        config.put("410-01/Mobilink/Mobilink Pakistan", new ZeroConfig("Pakistan", "Mobilink", createStartDate(2014, 1, 1), true, true, new String[] {"en", "ur", ""}, null));
        config.put("413-02/Dialog/Dialog Sri Lanka", new ZeroConfig("Sri Lanka", "Dialog", createStartDate(2014, 1, 1), false, true, new String[] {"en", "si", "simple", "ta", ""}, null));
        config.put("416-03/Umniah/Umniah Jordan", new ZeroConfig("Jordan", "Umniah", createStartDate(2014, 1, 1), true, true, new String[] {"en", "ar", ""}, null));
        config.put("420-01/Saudi Telecom/Saudi Telecom Saudi arabia", new ZeroConfig("Saudi arabia", "Saudi Telecom", createStartDate(2014, 1, 1), true, true, new String[] {"ar", "tl", "en", "bn", "ur", ""}, null));
        ...
        config.put("436-01/Tcell/Tcell Tajikistan", new ZeroConfig("Tajikistan", "Tcell", createStartDate(2014, 1, 1), true, true, new String[] {}, null));
        ...
        config.put("470-01/Gramenphone/Gramenphone Bangladesh", new ZeroConfig("Bangladesh", "Gramenphone", createStartDate(2014, 1, 1), false, true, new String[] {}, null));
        config.put("470-03/Banglalink/Banglalink Bangladesh", new ZeroConfig("Bangladesh", "Banglalink", createStartDate(2014, 1, 1), true, true, new String[] {"en", "bn", ""}, null));
        ...
        config.put("502-16/Digi/Digi Malaysia", new ZeroConfig("Malaysia", "Digi", createStartDate(2014, 1, 1), false, true, new String[] {}, null));
        config.put("510-11/XL Axiata/XL Axiata Indonesia", new ZeroConfig("Indonesia", "XL Axiata", createStartDate(2014, 1, 1), false, true, new String[] {"id", "en", "zh", "ar", "hi", "ms", "jv", "su", ""}, null));
        config.put("520-18/DTAC/DTAC Thailand", new ZeroConfig("Thailand", "DTAC", createStartDate(2014, 1, 1), false, true, new String[] {}, null));
        ...
        config.put("605-01/Orange/Orange Tunisia", new ZeroConfig("Tunisia", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {"fr", "ru", "ja", "zh", "it", "de", "en", "es", "ar", ""}, null));
        config.put("612-03/Orange/Orange Ivory Coast", new ZeroConfig("Ivory Coast", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {}, null));
        config.put("614-04/Orange/Orange Niger", new ZeroConfig("Niger", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {}, null));
        ...
        config.put("624-02/Orange/Orange Cameroon", new ZeroConfig("Cameroon", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {"fr", "ha", "ln", "yo", "eo", "ar", "zh", "en", "es", "de", ""}, null));
        config.put("630-86/Orange/Orange Democratic Republic of the Congo", new ZeroConfig("Democratic Republic of the Congo", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {}, null));
        ...
        config.put("639-03/Airtel/Airtel Kenya", new ZeroConfig("Kenya", "Airtel", createStartDate(2014, 1, 1), true, true, new String[] {}, null));
        config.put("639-07/Orange/Orange Kenya", new ZeroConfig("Kenya", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {}, null));
        config.put("641-14/Orange/Orange Uganda", new ZeroConfig("Uganda", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {"en", "zh", "ar", "hi", "fr", "sw", "rw", "de", "es", "ko", ""}, null));
        config.put("646-02/Orange/Orange Madagascar", new ZeroConfig("Madagascar", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {"fr", "en", "mg", ""}, null));
        config.put("652-02/Orange/Orange Botswana", new ZeroConfig("Botswana", "Orange", createStartDate(2014, 1, 1), true, false, new String[] {}, null));
        config.put("655-12/MTN/MTN South Africa", new ZeroConfig("South Africa", "MTN", createStartDate(2014, 1, 1), true, true, new String[] {}, null));
