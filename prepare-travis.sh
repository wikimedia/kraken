...
mvn install:install-file -DgroupId=org.apache.hadoop -DartifactId=hadoop-common -Dversion=$HADOOP_VERSION -Dpackaging=jar -Dfile=hadoop-common-$HADOOP_VERSION.jar
mvn install:install-file -DgroupId=org.apache.hadoop -DartifactId=hadoop-client -Dversion=$HADOOP_VERSION -Dpackaging=jar -Dfile=hadoop-client-$HADOOP_VERSION.jar
mvn install:install-file -DgroupId=org.apache.hadoop -DartifactId=hadoop-hdfs -Dversion=$HADOOP_VERSION -Dpackaging=jar -Dfile=hadoop-hdfs-$HADOOP_VERSION.jar
mvn install:install-file -DgroupId=org.apache.hadoop -DartifactId=hadoop-minicluster -Dversion=$HADOOP_VERSION -Dpackaging=jar -Dfile=hadoop-minicluster-$HADOOP_VERSION.jar
