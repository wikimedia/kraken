...
public class ProjectInfo {
    /** Map to match subdomain to indicator */
    private static final Map<String, String> SITE_VERSIONS = new HashMap<String, String>();

    /** Map containing all the valid Wikimedia language codes*/
