...
public class DemoFunnel {
     ...
     */
    public static void main(final String[] args) throws MalformedFunnelException, MalformedURLException {
        Funnel funnel;
     ...
     */
    public DirectedGraph<Node, DefaultEdge> createFakeUserHistory(final int numberNodes, final int numberEdges) throws MalformedFunnelException{
